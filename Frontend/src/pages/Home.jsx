    ...
    <div className="home-page">
      <div className="helpline-container">
        <h3 className="marquee" style={{ color: "crimson" }}>
          Helpline Numbers under the Tele-MANAS Programme : ☎️ 14416 or 📞 1-800
          891 4416
        </h3>
      </div>
      <div className="home-allcontent">
        ...
        <div className="home-project-intro">
          <p>
            We hope you enjoy our jokes as much as we do. HappyHeads has many
            such resources to make you smile even when you feel you can't. We
            also offer a variety of other resources to help you understand
            yourself better. After all we all deserve to know what is going
            inside us.
          </p>
        </div>
